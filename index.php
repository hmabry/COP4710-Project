...
<body>
	...
	<input type="text" id="iname" name="style" placeholder="Enter ingredient style" /><br />
	...
	$ingredient_sql = "INSERT INTO ingredient(name, style, amount, unit) VALUES ('$i_name', '$i_style', '$i_amount', '$i_unit')";
	
	 if(mysqli_query($db_handle, $ingredient_sql)){
        echo "Ingredient info added successfully.";
    } else{
        echo "ERROR" . mysqli_error($link);
    }
